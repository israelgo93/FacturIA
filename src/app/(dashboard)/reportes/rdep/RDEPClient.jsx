...
export default function RDEPClient() {
	...
	return (
		<div className="space-y-6">
			<div className="flex items-center gap-3">
				...
				<div>
					<h1 className="text-xl font-medium" style={{ color: 'var(--text-primary)' }}>RDEP - Relacion de Dependencia</h1>
					<p className="text-xs mt-1" style={{ color: 'var(--text-muted)' }}>Genera el XML anual de retenciones en relacion de dependencia</p>
				</div>
			</div>

			<GlassCard className="p-6">
				<div className="flex items-end gap-4">
					<GlassSelect label="Ano Fiscal" value={anio} onChange={(e) => setAnio(e.target.value)} options={ANIOS} />
